      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8">
          <div className="space-y-4 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl font-bold">Hi, I'm Sanjay Choudhary</h2>
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              I'm a passionate <span className="text-indigo-400">Frontend Developer</span> experienced in building responsive, high-performance web apps using <strong>React</strong>, <strong>Next.js</strong>, and <strong>Tailwind CSS</strong>.
            </p>
          </div>
