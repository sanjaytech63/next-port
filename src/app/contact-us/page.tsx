      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-8">
          ...
          <div className="space-y-4 text-sm text-gray-300">
            <p>
              <span className="text-white font-semibold">Name:</span> Sanjay Choudhary
            </p>
            <p>
              <span className="text-white font-semibold">Email:</span> johndoe@example.com
            </p>
            <p>
              <span className="text-white font-semibold">Phone:</span> 6376024125, 9376893981
            </p>
            <p>
              <span className="text-white font-semibold">Location:</span> Jaipur, Rajasthan
            </p>
          </div>
        </div>
